              ...
              <div>
                ...
                <div className="space-y-6 mb-12">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <span className="text-sm font-bold">Columbia, SC</span>
                  </div>
                </div>
              </div>
